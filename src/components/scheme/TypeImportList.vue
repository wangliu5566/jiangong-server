<template>
  <div class="know-import">
     <div class="system-title">
      ...
      <span @click="$router.push('/wrap/scheme/typeWrap')" style="cursor: pointer">分类体系管理 &gt;</span>
      <span class="other-color">导入报表</span>
      <Button type="primary" style='float:right;margin-right:20px' @click="$router.push('/wrap/scheme/typeWrap')">返回</Button>
    </div>
  ...
  <!--   <div class='aggregation'>
      <p>已入库分类：{{GetCateogryTotalCount}}</p>
    </div> -->
  </div>
</template>
<script>
