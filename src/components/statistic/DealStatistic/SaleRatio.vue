  ...
  <div class="statistic-col">
    <Row type="flex" justify="space-between">
      <div class="countClass">
        <div class="spanText">
          <span class="countTitle">销售额划分</span>
        </div>
...
export default {
  ...
  methods: {
    ...
    getListData() {
      ...
      myChart.showLoading();
      this.$http.get(this.ApiTransfer("/Order/OrderStatisticByPersonalOrOrganization"), {
          params:this.ApiTransfer("/Order/OrderStatisticByPersonalOrOrganization", {
