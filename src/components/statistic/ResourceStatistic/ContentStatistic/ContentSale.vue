  ...
  <div class="statistic-col">
    <Row type="flex" justify="space-between">
      <div class="countClass ">
        <div class="spanText">
          <span class="countTitle">内容销售统计<span class="count-sub-title">/销售额：{{formatPrice(totalMount,2)}}(元)</span></span>
        </div>
        ...
        .then((res) => {
          if (res.data.Success) {
            ...
            myChart.setOption({
              ...
              series: [{
                data: this.mapArrToArrByKey(res.data.Data.ItemList, 'Value1','Value2')
              }]
            });
            ...
            this.totalMount = res.data.Data.Additional.TotalAmount;
          }
        })
    },
  },
