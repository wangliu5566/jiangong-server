  ...
  <div class="statistic-col">
    <Row type="flex" justify="space-between">
      <div class="countClass">
        <div class="spanText">
          <span class="countTitle">用户类型统计</span>
        </div>
...
export default {
  ...
  methods: {
    ...
    getListData() {
      ...
      myChart.showLoading();
      this.$http.get(this.ApiTransfer("/User/IndependentUserAndOrganizationUserStatistic"), {
          params: this.ApiTransfer("/User/IndependentUserAndOrganizationUserStatistic", {
